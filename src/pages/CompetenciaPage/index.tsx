...
import { useCompetenciaData } from './useCompetenciaData';
...
export default function CompetenciaPage() {
  ...
  const { page, setPage, loading, filteredData, pagedData, chartData, hasSinglePoint } =
    useCompetenciaData(filtros, nomeBusca, ITEMS_PER_PAGE);
        ...
        <DataTable
          ...
          footer={
            <TableControls
              ...
              searchPlaceholder="Buscar competência por nome..."
